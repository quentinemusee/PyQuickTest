...
def map1(func: typing.Callable, x: typing.Iterable) -> typing.Iterable:
    """Map the given function over the elements of the given iterable."""
    return type(x)(map(func, x))

def map2(func: typing.Callable, x: typing.Iterable, y: typing.Iterable) -> typing.Iterable:
    """Map the given function over the elements of the two given iterables."""
    return type(x)(map(lambda arg: func(*arg), zip(x, y)))

def filter1(func: typing.Callable, x: typing.Iterable) -> typing.Iterable:
    """Filter the given iterable with the given boolean function."""
    return type(x)(filter(func, x))

def filter2(func: typing.Callable, x: typing.Iterable, y: typing.Iterable) -> typing.Iterable:
...
def get_all_functions(*attributes: str, ctx: typing.Optional[typing.Dict[str, typing.Any]] = None) -> typing.List[typing.Callable]:
...
def get_callable_ctx_from_file(file: str) -> typing.Dict[str, typing.Callable]:
...
def compute_group_length(core: typing.Dict[str, typing.Union[typing.Dict, typing.Callable]]) -> int:
